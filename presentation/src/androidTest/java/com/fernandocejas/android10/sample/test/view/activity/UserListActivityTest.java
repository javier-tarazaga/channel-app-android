...
import com.fernandocejas.android10.sample.presentation.view.stream.UserListActivity;
...
public class UserListActivityTest extends ActivityInstrumentationTestCase2<UserListActivity> {
  ...
  public void testContainsUserListFragment() {
    Fragment userListFragment =
        userListActivity.getFragmentManager().findFragmentById(R.id.fragment_container);
