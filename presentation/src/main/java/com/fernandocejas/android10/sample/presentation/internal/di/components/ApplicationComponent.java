...
import com.fernandocejas.android10.sample.data.net.ApiModule;
...
@Component(modules = { ApplicationModule.class, ApiModule.class }) public interface ApplicationComponent {
